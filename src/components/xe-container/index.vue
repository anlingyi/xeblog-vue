<template>
    <div class="container">
        <div class="headband">
            <a aria-label="View source on GitHub" class="github-corner" href="https://github.com/anlingyi">
                <svg aria-hidden="true" height="80" class="github-svg" viewBox="0 0 250 250" width="80">
                  ...
                  <path class="octo-body" d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,
                    ...
                    137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor"></path>
                </svg>
            </a>
        </div>
...
<style lang="less">
    ...
    @import '../../styles/mobile.less' (max-width: 950px);
